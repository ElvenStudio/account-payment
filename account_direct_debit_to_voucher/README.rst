...
=============================
Direct debit order to voucher
=============================

This module allows to generate customer vouchers from direct debit payment order,
based on direct debit data

Usage
=====

For 'done' direct debit orders, click on 'Create vouchers' button
